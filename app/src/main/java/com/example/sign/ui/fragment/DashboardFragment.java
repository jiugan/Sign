...
import com.example.sign.ui.activity.StudentDeleteClassActivity;
...
public class DashboardFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        classAdapter.setOnItemClickListener(new ClassAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int postion) {
                ...
                System.out.println(bean.courseId);
                Intent intent = new Intent(getActivity(), StudentDeleteClassActivity.class);
    ...
    private void getNewsList() {
        ...
        if (!StringUtils.isEmpty(id)){
            Call<ClassDetailsResponse> call = Api.api.StudentGetJoinClass(HiRetrofit.appId,HiRetrofit.appSecret,Integer.parseInt(id));
